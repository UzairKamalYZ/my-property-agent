...
# langchain_ollama — used by model/llm_factory.py
_lo = _stub("langchain_ollama")
_lo.OllamaLLM = MagicMock

# bs4 (BeautifulSoup) — used by scraping/web_scraper.py
_bs4 = _stub("bs4")
_bs4.BeautifulSoup = MagicMock

# pandas — used by housing/housing_csv_reader.py and housing/housing_data_collector.py
_stub("pandas")
